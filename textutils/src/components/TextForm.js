...
function TextForm(props) {
    ...
    const getTextLength = (text) => {
        return text.trim().split(" ").filter((word) => { return word !== ""; }).length;
    }
    ...
    return (
        <>
            <div className="container my-4" style={props.mode === "light" ? {color: "black"} : {color: "white"}}>
                ...
                <button className="btn btn-primary" onClick={handleLowerrCaseClick}>lower case</button>
                <button className="btn btn-primary mx-2" onClick={handleAlternatingCaseClick}>aLtErNaTeInG cAsE</button>
            ...
            <div className="container my-2" style={props.mode === "light" ? {color: "black"} : {color: "white"}}>
                ...
                <p>{0.48 * getTextLength(text)} Seconds read</p>
                <h3>Preview</h3>
